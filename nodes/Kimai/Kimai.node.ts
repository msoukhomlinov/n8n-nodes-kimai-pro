				...
				options: [
					{
						...
						routing: {
							request: {
								...
								body: {
									name: '={{$parameter["name"]}}',
									number: '={{$parameter["number"] ? $parameter["number"] : undefined}}',
									comment: '={{$parameter["comment"] ? $parameter["comment"] : undefined}}',
									company: '={{$parameter["company"] ? $parameter["company"] : undefined}}',
									vatId: '={{$parameter["vatId"] ? $parameter["vatId"] : undefined}}',
									contact: '={{$parameter["contact"] ? $parameter["contact"] : undefined}}',
									address_line1: '={{$parameter["addressLine1"] ? $parameter["addressLine1"] : undefined}}',
									address_line2: '={{$parameter["addressLine2"] ? $parameter["addressLine2"] : undefined}}',
									address_line3: '={{$parameter["addressLine3"] ? $parameter["addressLine3"] : undefined}}',
									postcode: '={{$parameter["postcode"] ? $parameter["postcode"] : undefined}}',
									city: '={{$parameter["city"] ? $parameter["city"] : undefined}}',
									country: '={{$parameter["country"]}}',
									currency: '={{$parameter["currency"]}}',
									phone: '={{$parameter["phone"] ? $parameter["phone"] : undefined}}',
									fax: '={{$parameter["fax"] ? $parameter["fax"] : undefined}}',
									mobile: '={{$parameter["mobile"] ? $parameter["mobile"] : undefined}}',
									email: '={{$parameter["email"] ? $parameter["email"] : undefined}}',
									homepage: '={{$parameter["homepage"] ? $parameter["homepage"] : undefined}}',
									timezone: '={{$parameter["timezone"]}}',
									invoiceText: '={{$parameter["invoiceText"] ? $parameter["invoiceText"] : undefined}}',
									invoiceTemplate: '={{$parameter["invoiceTemplate"] ? $parameter["invoiceTemplate"] : undefined}}',
									buyerReference: '={{$parameter["buyerReference"] ? $parameter["buyerReference"] : undefined}}',
									color: '={{$parameter["color"] ? $parameter["color"] : undefined}}',
									visible: '={{$parameter["visible"] ?? true}}',
									billable: '={{$parameter["billable"] ?? true}}',
								},
							},
					...
					},
					{
						...
						routing: {
							request: {
								...
								url: '=/api/customers/{{$parameter["id"]}}',
								body: {
									name: '={{$parameter["name"] ? $parameter["name"] : undefined}}',
									number: '={{$parameter["number"] ? $parameter["number"] : undefined}}',
									comment: '={{$parameter["comment"] ? $parameter["comment"] : undefined}}',
									company: '={{$parameter["company"] ? $parameter["company"] : undefined}}',
									vatId: '={{$parameter["vatId"] ? $parameter["vatId"] : undefined}}',
									...
									postcode: '={{$parameter["postcode"] ? $parameter["postcode"] : undefined}}',
									city: '={{$parameter["city"] ? $parameter["city"] : undefined}}',
									country: '={{$parameter["country"] ? $parameter["country"] : undefined}}',
									...
									email: '={{$parameter["email"] ? $parameter["email"] : undefined}}',
									homepage: '={{$parameter["homepage"] ? $parameter["homepage"] : undefined}}',
									timezone: '={{$parameter["timezone"] ? $parameter["timezone"] : undefined}}',
									invoiceText: '={{$parameter["invoiceText"] ? $parameter["invoiceText"] : undefined}}',
									invoiceTemplate: '={{$parameter["invoiceTemplate"] ? $parameter["invoiceTemplate"] : undefined}}',
									buyerReference: '={{$parameter["buyerReference"] ? $parameter["buyerReference"] : undefined}}',
									color: '={{$parameter["color"] ? $parameter["color"] : undefined}}',
