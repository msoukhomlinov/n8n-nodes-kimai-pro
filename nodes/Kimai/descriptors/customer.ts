...
export const customerDescriptor: ResourceDescriptor = {
	...
	parameters: [
		createIdParameter('Customer ID', resource, ['get', 'update', 'delete', 'updateMeta', 'getRates', 'addRate', 'deleteRate', 'getComments', 'addComment', 'deleteComment', 'pinComment', 'addTeam']),
		{
			displayName: 'Name',
			name: 'name',
			type: 'string',
		...
		},
		{
			...
			required: true,
			options: [
				{ name: 'Arabic', value: 'ar' }, { name: 'Bulgarian', value: 'bg' },
				{ name: 'Catalan', value: 'ca' }, { name: 'Czech', value: 'cs' },
				{ name: 'Danish', value: 'da' }, { name: 'German', value: 'de' },
				{ name: 'German (CH)', value: 'de_CH' }, { name: 'Greek', value: 'el' },
				{ name: 'English', value: 'en' }, { name: 'Esperanto', value: 'eo' },
				{ name: 'Spanish', value: 'es' }, { name: 'Basque', value: 'eu' },
				{ name: 'Persian', value: 'fa' }, { name: 'Finnish', value: 'fi' },
				{ name: 'Faroese', value: 'fo' }, { name: 'French', value: 'fr' },
				{ name: 'Hebrew', value: 'he' }, { name: 'Croatian', value: 'hr' },
				{ name: 'Hungarian', value: 'hu' }, { name: 'Indonesian', value: 'id' },
				{ name: 'Italian', value: 'it' }, { name: 'Japanese', value: 'ja' },
				{ name: 'Korean', value: 'ko' }, { name: 'Norwegian', value: 'nb_NO' },
				{ name: 'Dutch', value: 'nl' }, { name: 'Punjabi', value: 'pa' },
				{ name: 'Polish', value: 'pl' }, { name: 'Portuguese', value: 'pt' },
				{ name: 'Portuguese (BR)', value: 'pt_BR' }, { name: 'Romanian', value: 'ro' },
				{ name: 'Russian', value: 'ru' }, { name: 'Slovak', value: 'sk' },
				{ name: 'Slovenian', value: 'sl' }, { name: 'Swedish', value: 'sv' },
				{ name: 'Tamil', value: 'ta' }, { name: 'Turkish', value: 'tr' },
				{ name: 'Ukrainian', value: 'uk' }, { name: 'Vietnamese', value: 'vi' },
